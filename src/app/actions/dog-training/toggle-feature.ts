      ...
      for (const skill of ALL_DOG_SKILLS) {
        await tx.dogSkillDefinition.upsert({
          ...
          create: {
            ...
            stepsDe: skill.stepsDe ? JSON.stringify(skill.stepsDe) : null,
            stepsEn: skill.stepsEn ? JSON.stringify(skill.stepsEn) : null,
            mistakesDe: skill.mistakesDe ? JSON.stringify(skill.mistakesDe) : null,
            mistakesEn: skill.mistakesEn ? JSON.stringify(skill.mistakesEn) : null,
