  ...
  return (
    <div className="bg-card border border-border rounded-xl p-4 mb-4">
      <div className="flex justify-between items-center mb-3">
        ...
        <Link href="/quests" className="text-xs text-indigo-500 hover:text-indigo-700 transition-colors">
          {t('heading')} →
        </Link>
      </div>
      <div className="flex flex-col gap-2">
        {quests.map((q) => {
          ...
          return (
            <div key={q.id} className="p-3 rounded-lg border-l-[3px] border-indigo-400 bg-muted/50">
